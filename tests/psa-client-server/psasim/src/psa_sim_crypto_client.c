...
)
{
    ...
    ok = psa_crypto_call(PSA_HASH_ABORT, params, (size_t)(pos - params), &result, &result_length);
    if (!ok) {
...
)
{
    ...
    ok = psa_crypto_call(PSA_HASH_CLONE, params, (size_t)(pos - params), &result, &result_length);
    if (!ok) {
        printf("XXX server call failed\n");
        goto fail;
    }
...
)
{
    ...
    ok = psa_crypto_call(PSA_HASH_COMPARE, params, (size_t)(pos - params), &result, &result_length);
    if (!ok) {
        printf("XXX server call failed\n");
        goto fail;
    }
...
)
{
    ...
    ok = psa_crypto_call(PSA_HASH_COMPUTE, params, (size_t)(pos - params), &result, &result_length);
    if (!ok) {
        printf("XXX server call failed\n");
        goto fail;
    }
...
)
{
    ...
    ok = psa_crypto_call(PSA_HASH_FINISH, params, (size_t)(pos - params), &result, &result_length);
    if (!ok) {
        printf("XXX server call failed\n");
        goto fail;
    }
...
)
{
    ...
    ok = psa_crypto_call(PSA_HASH_SETUP, params, (size_t)(pos - params), &result, &result_length);
    if (!ok) {
        printf("XXX server call failed\n");
        goto fail;
    }
...
)
{
    ...
    ok = psa_crypto_call(PSA_HASH_UPDATE, params, (size_t)(pos - params), &result, &result_length);
    if (!ok) {
        printf("XXX server call failed\n");
        goto fail;
    }
...
)
{
    ...
    ok = psa_crypto_call(PSA_HASH_VERIFY, params, (size_t)(pos - params), &result, &result_length);
    if (!ok) {
        printf("XXX server call failed\n");
        goto fail;
    }
